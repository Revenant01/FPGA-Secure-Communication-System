...
set_property IOSTANDARD LVCMOS33 [get_ports reset]
#set_property PACKAGE_PIN T18 [get_ports {tx_enable}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {tx_enable}]
#set_property PACKAGE_PIN W19 [get_ports {Player1_up}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Player1_up}]
#set_property PACKAGE_PIN T17 [get_ports {Player2_down}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Player2_down}]
#set_property PACKAGE_PIN U17 [get_ports {Player1_down}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Player1_down}]
